...
<div class="modal-header">
<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true" >& times;</span></button>
<h4 class="modal-title"><i class="fa fa-plus"></i>Modal title</h4>
</div>
...
<!-- /remove brand -->
<h1><a href="export_brands.php" class="btn btn-success">Export to Excel</a>
